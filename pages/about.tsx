export default function About()
{
    return (
        <>
            <div className="w-full flex flex-1 lg:flex-row flex-col md:items-center lg:bg-[url('/public/images/bg-about.png')] bg-[url('./images/geometric-background-50.png')] bg-no-repeat bg-cover z-0 bg-opacity-5 lg:bg-opacity-100">
                ...
                <div className="2xl:w-[45%] lg:w-[50%] w-[100%] h-full flex justify-center flex-col lg:mt-0 mt-20 px-14 py-10">
                    <p className="2xl:text-7xl lg:text-6xl md:text-6xl text-5xl text-secondary font-light lg:text-left text-center">ABOUT</p>
                    <p className="mt-20 text-base text-xl">
