                ...
                <div className="w-full flex flex-col justify-center py-20 my-5 lg:px-56 md:px-20 2xl:px-80 px-7">
                    <div className="w-full mt-20">
                        <div className="flex flex-row items-center">
                            <div className="py-2 px-2 shadow-[rgba(0,0,0,0.1)_0px_6px_24px_0px,_rgba(0,0,0,0.4)_0px_0px_0px_1px] rounded-full w-28">
                                <p className="tex-xl font-[600] text-center">Simpllify</p>
                            </div>
                            <p className="font-[600] ml-5 text-[rgb(110,110,110)]">01/2023 - present</p>
                        </div>
                    ...
                    <div className="w-full mt-20">
                        <div className="flex flex-row items-center">
                            ...
                            <p className="font-[600] ml-5 text-[rgb(110,110,110)]">09/2022 - present</p>
                        </div>
                    ...
                    <div className="w-full mt-20">
                        <div className="flex flex-row items-center">
                            ...
                            <p className="font-[600] ml-5 text-[rgb(110,110,110)]">05/2022 – 06/2022</p>
                        </div>
                    ...
                    <div className="w-full mt-20">
                        <div className="flex flex-row items-center">
                            ...
                            <p className="font-[600] ml-5 text-[rgb(110,110,110)]">01/2022 – 02/2022</p>
                        </div>
                    ...
                    <div className="w-full mt-20">
                        <div className="flex flex-row items-center">
                            ...
                            <p className="font-[600] ml-5 text-[rgb(110,110,110)]">04/2022 - 05/2022</p>
                        </div>
                    ...
                    <div className="w-full mt-20">
                        <div className="flex flex-row items-center">
                            ...
                            <p className="font-[600] ml-5 text-[rgb(110,110,110)]">09/2021 - 10/2021</p>
                        </div>
                    ...
                    <div className="w-full mt-20">
                        <div className="flex flex-row items-center">
                            ...
                            <p className="font-[600] ml-5 text-[rgb(110,110,110)]">09/2020 – 09/2020</p>
                        </div>
